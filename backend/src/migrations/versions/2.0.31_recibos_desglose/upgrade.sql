...
<div class="recibo-item">
  ...
  <table class="recibo-desglose">
    <tr><td class="desglose-label">Cuota Social</td><td class="desglose-value">{{cuota_social}}</td></tr>
    <tr class="desglose-arancel {{arancel_negativo_class}}"><td class="desglose-label">Arancel por Servicio</td><td class="desglose-value">{{arancel_por_servicio}}{{arancel_warning_icon}}</td></tr>
    <tr class="desglose-total"><td class="desglose-label"><strong>Valor Total Cuota</strong></td><td class="desglose-value"><strong>{{valor_cuota}}</strong></td></tr>
  </table>
</div>'
);
