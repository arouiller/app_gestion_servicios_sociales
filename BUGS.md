...
|----|-----------|------|-------------|-----------|------------|--------|
| BUG-054 | 🔴 CRÍTICO | Template Editor | PDF generation usa template activo con soporte correcto para múltiples recibos por página | 2026-06-16 | 2026-06-16 | 7a2054b, eddc3e2, 201d951, 6da959c |
