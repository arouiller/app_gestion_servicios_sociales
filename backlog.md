...
| BACKLOG-079 | 🔴 Alta | 📋 Registrado | Registrar 3 valores en tabla Recibo: cuota_social, arancel_por_servicio, valor_cuota | Al generar recibos, registrar 3 valores desglosados: (1) cuota_social = valor del parámetro "Valor Cuota Social"; (2) arancel_por_servicio = valor_cuota_plan - valor_cuota_social; (3) valor_cuota = valor_cuota_plan (ya implementado). Requiere: migración para agregar 2 columnas a tabla recibos, actualización de recibosController en generación, actualización de ReciboDetalleModal para mostrar desglose, actualización de recibosService. | migrations/2.0.30, Recibo.js, recibosController.js, recibosService.js, ReciboDetalleModal.jsx |
