...
|----|-----------|--------|-------------|-------------------|----|
| BACKLOG-052 | 🟡 Media | 📋 Registrado | Redimensionamiento manual de columnas con persistencia en localStorage | Permitir que los usuarios cambien manualmente el ancho de las columnas en las tablas (GestionPlanesV1, BusquedaAfiliados, LookupCRUD, etc.). Las preferencias de ancho se guardan en localStorage y persisten entre sesiones del navegador. Mejora UX: usuarios pueden ajustar columnas según sus preferencias. | GestionPlanesV1.jsx, BusquedaAfiliados.jsx, LookupCRUD.jsx, useColumnWidths hook, _table-standard.scss |
