...
|----|-----------|--------|-------------|-------------------|----|
| BACKLOG-040 | 🔴 Alta | 🚀 Desarrollado | Selector de Zona en Formulario de Afiliados | En PlanV1Modal, agregar selector dropdown de Zona. Carga zonas desde la provincia seleccionada del plan. Campo zona_id en plan_integrantes. Permite asignar zona a cada afiliado del plan. | PlanV1Modal.jsx, planesController.js (actualizar /planes POST/PUT), zonaService.js |
