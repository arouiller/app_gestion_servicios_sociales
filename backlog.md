...
|----|-----------|--------|-------------|-------------------|--------------------|
| BACKLOG-006 | 🔴 Alta | ✅ Completado | Flujo de login para usuarios con password blanqueada | Implementado: Checkbox "Tengo contraseña blanqueada" en LoginPage. Backend detecta password_blanqueada y retorna flag debe_cambiar_password. Frontend redirige a /cambiar-password. Flujo completo funcional para onboarding de nuevos usuarios | LoginPage.jsx, authService.js, auth.js |
