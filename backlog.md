...
| BACKLOG-077 | 🔴 Alta | 📋 Registrado | Remover sticky header en Gestión de Planes | Actualmente el scroll en tabla de planes mantiene la parte superior (header + filtros) fija mientras la tabla se mueve. Requerimiento: volver al comportamiento original donde toda la página scrollea sin partes fijas. Mejora UX estándar. | GestionPlanesV1.jsx, GestionPlanesV1.scss |
