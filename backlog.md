...
|----|-----------|--------|-------------|-------------------|----|
| BACKLOG-052 | 🟡 Media | 🚀 Desarrollado | Redimensionamiento manual de columnas con persistencia en localStorage | Permitir que los usuarios cambien manualmente el ancho de las columnas en las tablas (GestionPlanesV1, LookupCRUD). Las preferencias de ancho se guardan en localStorage y persisten entre sesiones del navegador. Mejora UX: usuarios pueden ajustar columnas según sus preferencias. Hook useColumnResize con drag & drop en headers. Commits: 2c816f9, 56a3e0b, effa576, 2d2b9c5 | useColumnResize hook, GestionPlanesV1.jsx, LookupCRUD.jsx, _table-standard.scss |
