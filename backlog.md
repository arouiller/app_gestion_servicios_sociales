...
|----|-----------|--------|-------------|-------------------|----|
| BACKLOG-062 | 🟡 Media | ✅ Incorporado al plan | Optimizar actualización de planes: endpoint único para PUT + sync integrantes + PATCH | Actualmente hay 4 llamadas al guardar cambios en plan existente (PUT, GET, GET, PATCH). Se consolida en 1 endpoint POST /planes/actualizar-completo/:id que actualiza plan + sincroniza integrantes + reordena, retornando todo actualizado en transacción atómica. Reduce latencia y simplifica sincronización. | planesController.js, planesV1Service.js, PlanV1Modal.jsx |
| BACKLOG-061 | 🟡 Media | 🚀 Desarrollado | Optimizar creación de planes: endpoint único para plan + personas + integrantes | Implementado: POST /planes/crear-completo consolida 6 llamadas en 1. Transacción atómica Sequelize. Backend maneja personas deferred, integrantes y reorder en una sola operación. Frontend usa 1 llamada en lugar de 6. Commit: 89dfe24 | planesController.js, planesV1Service.js, PlanV1Modal.jsx |
