...
| BACKLOG-076 | 🔴 Alta | 🚀 Desarrollado | Navegación por teclado en PlanV1Modal: Enter para abrir plan + atajos de tabs | Implementado: (1) GestionPlanesV1.jsx: ALT+G reemplazado por Enter para abrir plan. (2) PlanV1Modal.jsx: atajos ALT+A (Afiliados), ALT+R (Recibos), ALT+D (Datos), ALT+H (Historial) + auto-focus en primer componente interactivo de cada tab. (3) Nuevo hook useTabNavigation.js para reutilización. Commits: 0490891, 8b3074f, 46b6d96 | GestionPlanesV1.jsx, PlanV1Modal.jsx, useTabNavigation.js |
