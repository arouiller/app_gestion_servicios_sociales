...
|----|-----------|--------|-------------|-------------------|----|
| BACKLOG-034 | 🔴 Alta | 🚀 Desarrollado | Herramienta de Ejecución de Queries SQL (Admin Only) | Administrador puede ingresar una query SQL, ejecutarla y ver resultados. Útil para auditoría, diagnóstico y análisis de datos. Solo SELECT permitido, con límite de resultados y logging de ejecución. | queryExecController.js, admin.js, QueryExecPage.jsx, queryExecService.js |
