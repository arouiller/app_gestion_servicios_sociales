...
|----|-----------|--------|-------------|-------------------|----|
| BACKLOG-061 | 🟡 Media | ✅ Incorporado al plan | Optimizar creación de planes: endpoint único para plan + personas + integrantes | Actualmente hay 6 llamadas al crear un plan (crear plan, crear personas, crear integrantes, obtener integrantes x2, reorder). Se puede consolidar en 1 llamada única POST /planes/crear-completo que acepte plan + afiliados y retorne todo creado. Mejora: menos latencia, transacción atómica. | planesController.js, planesV1Service.js, PlanV1Modal.jsx |
